...
CREATE INDEX IX_A_IMPORTED_SELECTION_STUDENT_NO ON dbo.A_IMPORTED_SELECTION (source_college, student_no);
...
UNION ALL
SELECT
    CONCAT(course_no, '-', source_college, '-', student_no) AS id,
